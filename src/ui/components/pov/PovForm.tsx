...
interface PovFormProps {
  pov?: Partial<PoV> | null;
  onSubmit: (formData: any, triggerServerPost: boolean) => void;
  onCancel: () => void;
  loading?: boolean;
  title?: string;
}

const PovForm: React.FC<PovFormProps> = ({
  pov = null,
  onSubmit,
  onCancel,
  loading = false,
  ...
  const handleSubmit = (e?: React.FormEvent | React.MouseEvent, triggerServerPost = false) => {
