...
const Layout = () => {
  ...
  // Safe mapping for user properties whether it's Firebase User or our model
  const displayName = userAccount?.displayName || (userAccount as any)?.name?.full || "User";
  const displayPicture = userAccount?.displayPicture || (userAccount as any)?.photoURL || "";
